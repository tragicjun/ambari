...
from HostCheckReportFileHandlerManually import HostCheckReportFileHandlerManually
...
class HostInfoManually:
  ...
  DEFAULT_PROJECT_NAMES = [
    ...
    "webhcat", "hadoop-hdfs", "hadoop-yarn", "hadoop-mapreduce","thive","pgxz","lhotse"
  ]
  ...
  DEFAULT_DIRS = [
    "/etc", "/var/run", "/var/log", "/usr/lib", "/var/lib", "/var/tmp", "/tmp", "/var","/usr/local","/data", "/hadoop"
  ]
  ...
  def __init__(self, config=None):
    ...
    self.config = config
    self.reportFileHandler = HostCheckReportFileHandlerManually(config)
