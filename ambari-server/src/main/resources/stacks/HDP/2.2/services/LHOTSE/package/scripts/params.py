...
lhotse_runner_cgi_port = default("/configurations/lhotse-runner/cgi.port", 81)
...
service_listen_port = default("/configurations/lhotse-service/listen.port", 8088)
...
lhotse_web_listen_port = default("/configurations/lhotse-web/listen.port", 8088)
...
ftp_server_port = default("/configurations/lhotse-ftp/lhotse.ftp.port", 21)
