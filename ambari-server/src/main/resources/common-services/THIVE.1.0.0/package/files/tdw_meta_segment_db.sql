...
--
-- Name: tbl_part_format_info; Type: TABLE; Schema: public; Owner: tdwmeta; Tablespace: 
--

CREATE TABLE tbl_part_format_info (
    tbl_id bigint NOT NULL,
    pri_part character varying NOT NULL,
    input_format character varying NOT NULL,
    output_format character varying NOT NULL,
    serde_lib character varying NOT NULL
);


ALTER TABLE public.tbl_part_format_info OWNER TO tdwmeta;
...
--
-- Name: tbl_part_format_info_pkey; Type: CONSTRAINT; Schema: public; Owner: tdwmeta; Tablespace: 
--

ALTER TABLE ONLY tbl_part_format_info
    ADD CONSTRAINT tbl_part_format_info_pkey PRIMARY KEY (tbl_id, pri_part);
...
--
-- Name: tbl_part_format_info_tbl_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tdwmeta
--

ALTER TABLE ONLY tbl_part_format_info
    ADD CONSTRAINT tbl_part_format_info_tbl_id_fkey FOREIGN KEY (tbl_id) REFERENCES tbls(tbl_id) ON DELETE CASCADE;


--
-- Name: tbl_part_format_info_tbl_id_fkey; Type: INDEX; Schema: public; Owner: tdwmeta
--

CREATE INDEX tbl_part_format_info_tbl_id_idx ON tbl_part_format_info(tbl_id);
